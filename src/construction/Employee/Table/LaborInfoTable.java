...
public class LaborInfoTable extends javax.swing.JFrame {

    /**
     * Creates new form LaborInfoTable
     */
    
    public LaborInfoTable(EmployeePage employeePage) {
        initComponents();
        displayTable();
        setResizable(true);
    ...
    public void displayTable(){
        ...
        for(int i=0;i<list.size();i++){
            ...
            row[7]=list.get(i).getDailySalary();
            row[8]=list.get(i).getOverTime();
            row[9]=list.get(i).getBonus();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Name", "Contact", "Email", "Address", "EmergencyContact", "NID", "DailySalary", "OverTime", "Bonus"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LaborInfoTable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new LaborInfoTable().setVisible(true);
            }
        });
    }
