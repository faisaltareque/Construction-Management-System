 ...
 */
package construction.Payment.PayemntQueries;

import construction.Payment.*;
...
public class PaymentTable extends javax.swing.JFrame {
    ...
    public PaymentTable(PaymentQueryPage paymentPage,int type,String date,String id) {
        initComponents();
        this.type=type;
        this.date=date;
        this.id=id;
    ...
    public ArrayList<Payment> List(){
        ...
        try{
            ...
            String query="";
            if(type==1){
                query="select * from Payment where date like '"+date+"' and ToPayment like '%mp%'";
            }
            if(type==2){
                query="select * from Payment where date like '"+date+"' and ToPayment like '%ll%'";
            }
            if(type==3){                
                query="select * from Payment where ReceiverID like '"+id+"'";
            }
            if(type==4){
                query="select * from Payment order by Amount desc";
            }
            if(type==5){
                query="select * from Payment where Type like '%Cash%'";
            }
            if(type==6){
                query="select * from Payment where Type like '%Bank%'";
            }
