...
import construction.Purchase.Queries.PurchaseOnDateInfo;
import construction.Purchase.Queries.SellerInfoOfPurchase;
 ...
 * @author faisa
 */
public class PurchaseQueryPage extends javax.swing.JFrame {

    /**
     * Creates new form PurchaseQueryPage
     */
    public PurchaseQueryPage(PurchasePage purchasePage) {
        initComponents();
        getComboBoxOption();
        setResizable(false);
    ...
    private void getComboBoxOption(){
        ...
        try{
            Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
            Connection connection = DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=Construction;selectMethod=cursor", "sa", "123456");
            String query="select TrID as ID from Purchase";         
            Statement statement = connection.createStatement();
            ResultSet resultSet = statement.executeQuery(query);
            while(resultSet.next()){
                String o=resultSet.getString("ID");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Purchase Queries");

        jLabel2.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        jLabel2.setText("Purchase on Date:");
        ...
        jLabel3.setText("Purchase from Seller:");
        ...
        jLabel4.setText("Seller info of Purchase:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String trDate=date;
        PurchaseOnDateInfo purchaseOnDateInfo=new PurchaseOnDateInfo(this, 1, date, "");
        setEnabled(false);
        purchaseOnDateInfo.setVisible(true);
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        PurchaseOnDateInfo purchaseOnDateInfo=new PurchaseOnDateInfo(this, 2, "", jComboBox1.getSelectedItem().toString());
        setEnabled(false);
        purchaseOnDateInfo.setVisible(true);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        SellerInfoOfPurchase sellerInfoOfPurchase=new SellerInfoOfPurchase(this, jComboBox2.getSelectedItem().toString());
        setEnabled(false);
        sellerInfoOfPurchase.setVisible(true);
        
    }//GEN-LAST:event_jButton4ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        PurchaseOnDateInfo purchaseOnDateInfo=new PurchaseOnDateInfo(this, 3, "", "");
        setEnabled(false);
        purchaseOnDateInfo.setVisible(true);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        // TODO add your handling code here:
        PurchaseOnDateInfo purchaseOnDateInfo=new PurchaseOnDateInfo(this, 4, "", "");
        setEnabled(false);
        purchaseOnDateInfo.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PurchaseQueryPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new PurchaseQueryPage().setVisible(true);
            }
        });
    }
